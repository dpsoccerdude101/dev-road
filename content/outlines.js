let quiz = 'html	accessibility		css			render pipeline	media query	flexbox	grid		grid functions/units	grid template		github/ markdowm		images		svg'.split('\t')
let proj = 'Resume	Tribute Page		Survey Form		Technical Doc Page			Product Landing Page					Portfolio Page						'.split('\t')
let hw = '	Basic HTML & HTML5	Applied Accessibility		Basic CSS		Applied Visual Design		Responsive Web Design Principles	CSS Flexbox			CSS Grid		FCC Proj Checkup					'.split('\t')
