export const rows = [
  ...
  { level: ["iii"], topic: "State Management (Redux)", hours: 6 },
  { level: ["iii"], topic: "React/Redux Dev Tools", hours: 3 },
  { level: ["iii"], topic: "Advanced React Patterns", hours: 3 },
  { level: ["iii"], topic: "Project: Firebase CRUD Application", hours: 12 },
  { level: ["iii"], topic: "Resume, Interviewing and Career Skills", hours: 6 },
...
export const details = [
  ...
  },
  {
    title: "Instructors:",
    content:
      "W. Jamie Vaughn wvaughniv@monroecc.edu, Dennis Pavlyuk dennispavlyuk@gmail.com, Keiran Pillman keiran.pillman@gmail.com",
    icon: "notes.svg",
  },
];
...
export const sections = [
  {
    title: "Tool Tips!",
    content:
      "Overview of the most useful web development tools for every developer",
    icon: "checked_circle.svg",
  },
  {
    title: "Main Lecture Topic",
    content:
      "Review of concepts and web standards via slides and documentation",
    icon: "checked_circle.svg",
  },
  {
